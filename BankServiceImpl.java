...
public class BankServiceImpl implements BankService {
	...
	public boolean isValidMutualFund(Map<String, MutualFund> mutualFund){
		boolean check = false;
		if(((MutualFund) mutualFund).getNav()>0 && ((MutualFund) mutualFund).getMfunits()>0){
			check=true;
		}
		return check;
	}
	...
	public void updateMF(Map<String, MutualFund> mutualFund) throws IBSException {
